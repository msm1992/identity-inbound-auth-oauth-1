...
public class SQLQueries {
    ...
    public static final String VALIDATE_AUTHZ_CODE = "SELECT AUTHZ_USER, USER_DOMAIN, TENANT_ID, SCOPE, " +
            ...
            "CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND AUTHORIZATION_CODE_HASH = ?";
...
//            "ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID";
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_DB2SQL = "SELECT ACCESS_TOKEN, AUTHZ_USER, " +
            ...
            " FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_INFORMIX = "SELECT ACCESS_TOKEN, AUTHZ_USER, " +
            ...
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER FROM IDN_OAUTH2_ACCESS_TOKEN " +
            "WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND REFRESH_TOKEN_HASH = ? " +
    ...
    public static final String RETRIEVE_SCOPE_WITH_TENANT_FOR_RESOURCE = "SELECT SCOPES.NAME, SCOPES.TENANT_ID FROM " +
            ...
            "SCOPERESOURCES.SCOPE_ID = SCOPES.SCOPE_ID AND SCOPES.NAME NOT LIKE 'productscope%'";

    public static final String RETRIEVE_PRODUCT_SCOPES_FOR_RESOURCE = "SELECT SCOPES.NAME FROM " +
            "IDN_OAUTH2_SCOPE AS SCOPES, IDN_OAUTH2_RESOURCE_SCOPE AS SCOPERESOURCES WHERE RESOURCE_PATH = ? AND " +
            "SCOPERESOURCES.SCOPE_ID = SCOPES.SCOPE_ID AND SCOPES.NAME LIKE 'productscope%'";
